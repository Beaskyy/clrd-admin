...
export default function TransactionDetails() {
  ...
  const { data, isLoading, error } = useTransactionDetail(courierId, transactionUuid);
      ...
      <div className="flex flex-col gap-[22px] md:p-9 p-5 bg-[#F5F5F5]">
        <div className="bg-white rounded-lg p-6">
          ...
          <p className="text-[#667085]">
            The transaction you&apos;re looking for doesn&apos;t exist or there was
      ...
      <div className="flex flex-col gap-6 md:p-9 p-5 bg-[#F5F5F5]">
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
            ...
            <div>
              <label className="lg:text-sm text-xs text-[#667085]">Category</label>
