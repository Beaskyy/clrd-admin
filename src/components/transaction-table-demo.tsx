...
import { useTransactionsMock } from "@/hooks/use-transactions-mock";
...
export const TransactionTableDemo = () => {
  const [filters, setFilters] = useState({
    sort: "desc" as const,
    per_page: 10,
  });

  const { data, isLoading, error, refetch } = useTransactionsMock(filters);
